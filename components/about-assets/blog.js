...
import { AboutBlogWrapper } from './styles.css'
        ...
        <div className="update-container bg-gray-000 drop-shadow-lg md:w-1/2">
          <div className="p-8">
            ...
            <p className="text-gray-800/70 mb-6">
              Algodev, Inc. – the company behind Algodex – is delighted to announce it is the latest
              recipient of an Algorand Foundation Grant. Algodex will deliver …
            </p>
