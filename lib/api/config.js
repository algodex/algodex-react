...
export const tradeHistoryQueries = {
  ...
  getTradeHistoryByAddress: {
    key: '[trade-history]-get-trade-history-by-address',
    fetchFunction: getTradeHistoryByAddress,
    options: {
      refetchInterval: 3000,
      retryDelay: 3000
    }
...
export const walletAssetsQueries = {
  getAssetsByAddress: {
    key: '[wallet-assets]-get-wallet-assets-by-address',
    fetchFunction: getAssetsByAddress,
    options: {
      refetchInterval: 3000,
      retryDelay: 3000
    }
