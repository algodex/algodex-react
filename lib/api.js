...
const API_HOST = process.env.NEXT_PUBLIC_API || 'https://api-testnet.algodex.com'
...
export async function fetchAssetsByAddress(walletAddress) {
  if (!walletAddress) {
    throw new Error(`Error fetching asset: wallet address not provided`)
  }
