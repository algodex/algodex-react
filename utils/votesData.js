export const votesArray = [
  {
    appId:
      process.env.NEXT_PUBLIC_ALGORAND_NETWORK.toLowerCase() === 'testnet' ? 287726836 : 1165656814,
  ...
  {
    appId:
      process.env.NEXT_PUBLIC_ALGORAND_NETWORK.toLowerCase() === 'testnet' ? 287730432 : 1165656814,
    appId:
      process.env.NEXT_PUBLIC_ALGORAND_NETWORK.toLowerCase() === 'testnet' ? 287730432 : 1165656814,
  ...
  {
    appId:
      process.env.NEXT_PUBLIC_ALGORAND_NETWORK.toLowerCase() === 'testnet' ? 284837932 : 1165656814,
