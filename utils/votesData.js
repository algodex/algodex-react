export const votesArray = [
  {
    appId: process.env.NEXT_PUBLIC_ENVIRONMENT === 'testnet' ? 284837932 : 1165656814,
    ...
    startDate: '2023-08-07T22:54:00.000Z',
    ...
    question: {
      ...
      options: ['10 million', '21 million', '50 million']
    }
  },
  {
    appId: process.env.NEXT_PUBLIC_ENVIRONMENT === 'testnet' ? 284837932 : 1165656814,
    ...
    startDate: '2023-08-07T19:54:00.000Z',
  ...
  },
  {
    ...
    startDate: '2023-06-01T20:00:00.000Z',
    endDate: '2023-06-22T20:00:00.000Z',
    question: {
      title:
        'What is the process called where new cryptocurrency tokens are created and distributed to the network participants?',
      description: 'Please choose one of the following options',
      options: ['Mining', 'Staking', 'Airdrop']
    }
  },
  {
    appId: process.env.NEXT_PUBLIC_ENVIRONMENT === 'testnet' ? 284837932 : 1165656814,
    ...
    question: {
      title:
        'Which consensus algorithm does Ethereum plan to transition to in order to become more energy-efficient?',
      description: 'Please choose one of the following options',
      options: ['Proof of Work (PoW)', 'Delegated Proof of Stake (DPoS)', 'Proof of Stake (PoS)']
    }
  },
  {
    appId: process.env.NEXT_PUBLIC_ENVIRONMENT === 'testnet' ? 284837932 : 1165656814,
    ...
    endDate: '2023-05-13T10:00:00.000Z',
    question: {
      title:
        'Which cryptocurrency was created as a joke or meme but gained significant popularity?',
      description: 'Please choose one of the following options',
      options: ['Litecoin', 'Ethereum', 'Dogecoin']
    }
  },
  {
    appId: process.env.NEXT_PUBLIC_ENVIRONMENT === 'testnet' ? 284837932 : 1165656814,
    ...
    startDate: '2023-08-05T10:00:00.000Z',
    endDate: '2023-08-22T10:00:00.000Z',
    question: {
      title:
        'What is the term for a cryptographic token that represents ownership in a real-world asset?',
      description: 'Please choose one of the following options',
      options: ['Stablecoin', 'Security token', 'Utility token']
    }
  },
  {
    appId: process.env.NEXT_PUBLIC_ENVIRONMENT === 'testnet' ? 284837932 : 1165656814,
    ...
    startDate: '2023-08-31T10:00:00.000Z',
    endDate: '2023-09-22T10:00:00.000Z',
    question: {
      title:
        'What is the process of verifying and adding new transactions to the blockchain called?',
      description: 'Please choose one of the following options',
      options: ['Mining', 'Hashing', 'Hashrate']
    }
  }
]
