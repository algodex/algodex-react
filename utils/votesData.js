export const votesArray = [
  ...
  },
  {
    ...
    question: {
      ...
      description: 'Please choose one of the following options',
      options: ['Mining', 'Staking', 'Airdrop', 'ICO (Initial Coin Offering)']
    }
  },
  {
  ...
  },
  {
    ...
    question: {
      ...
      description: 'Please choose one of the following options',
      options: ['Litecoin', 'Ethereum', 'Dogecoin', 'Ripple']
    }
  },
  {
    ...
    question: {
      ...
      description: 'Please choose one of the following options',
      options: ['Stablecoin', 'Security token', 'Utility token', 'Non-fungible token (NFT)']
    }
  },
  {
    ...
    question: {
      ...
      description: 'Please choose one of the following options',
      options: ['Mining', 'Hashing', 'Hashrate', 'SegWit']
    }
  }
]
